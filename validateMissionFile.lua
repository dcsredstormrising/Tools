...
local fuelSettings = {
    A_10A = { capacity = 5029, fraction = 0.5 },
    A_10C = { capacity = 5029, fraction = 0.5 },
    A_10C_2 = { capacity = 5029, fraction = 0.5 },
    ...
    F_14A_135_GR = { capacity = 7348, fraction = 1.0 },
    F_14B = { capacity = 7348, fraction = 1.0 },
    F_15C = { capacity = 6103, fraction = 0.2 },
    F_16C_50 = { capacity = 3249, fraction = 1.0 },
    F_5E_3 = { capacity = 2046, fraction = 1.0 },
    ["F_86F Sabre"] = { capacity = 1282, fraction = 1.0 },
    FA_18C_hornet = { capacity = 4900, fraction = 1.0 },
    ...
    J_11A = { capacity = 9400, fraction = 0.1 },
    JF_17 = { capacity = 2325, fraction = 1.0 },
	...
	Mi_24P = { capacity = 1500, fraction = 0.4 },
    MiG_15bis = { capacity = 1172, fraction = 1.0 },
    MiG_19P = { capacity = 1800, fraction = 1.0 },
    MiG_21Bis = { capacity = 2280, fraction = 1.0 },
    MiG_29A = { capacity = 3376, fraction = 0.7 },
    MiG_29G = { capacity = 3376, fraction = 0.7 },
    MiG_29S = { capacity = 3493, fraction = 0.7 },
    ...
    Su_25 = { capacity = 2835, fraction = 0.5 }, 
    Su_25T = { capacity = 3790, fraction = 0.5 },
    Su_27 = { capacity = 5590.18, fraction = 0.5 },
    Su_33 = { capacity = 9500, fraction = 0.1 },
...
local radioSettings = {
    red = {
        ...
        JF_17 = { { channels = { 126, 121, 141, 142, 143, 133, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114 } } },
    },
    blue = {
...
local function setJF17Options(unit, sideName)
    print("INFO:  Setting options for " .. description(unit))
    unit.AddPropAircraft.AARProbe = true
    if sideName == "red" then
        unit.AddPropAircraft.LaserCode1 = 6
    else
        unit.AddPropAircraft.LaserCode1 = 7
...
options.miscellaneous.F2_view_effects = 1
...
options.difficulty.optionsView = "optview_allies"
options.difficulty.externalViews = false
options.difficulty.cockpitVisualRM = true
options.plugins.CA.ground_aim_helper = false
options.playerName = "RSR"
